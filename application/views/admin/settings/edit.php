...
<div class="row form-group">
	<div class="col-3 form-collabel">
		Заголовок меню: <span class="required">*</span>
	</div>
	<div class="col-9 form-colinput">
		<input type="text" class="form-input" name="menuTitle" value="<?=set_value('menuTitle', $siteinfo['menuTitle']);?>" />
		<?=form_error('menuTitle'); ?>
	</div>
</div>
<div class="row form-group">
	<div class="col-3 form-collabel">
