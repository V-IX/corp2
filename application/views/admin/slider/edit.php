...
<div class="row form-group">
	...
	<div class="col-9 form-colinput">
		<input type="text" class="form-input" name="btnText" data-html="btn_a" value="<?=set_value('btnText', $item['btnText'])?>" />
		<?=form_error('btnText'); ?>
	</div>
</div>
<div class="row form-group">
...
<div class="row form-group">
	...
	<div class="col-9">
		<?
			...
			else $fw_active = $title_css['font-weight'] == 700 ? '_active' : '';
		...
		<div class="slide-squares">
			...
			<span class="slide-square" id="color" style="background: #<?=set_value('slide_css[color]', $slide_css['color']);?>;"></span>
		</div>
		...
		<input type="hidden" name="slide_css[color]" id="colorInput" value="<?=set_value('slide_css[color]', $slide_css['color']);?>" />
	</div>
</div>
<div class="row form-group">
	<div class="col-3 form-collabel">
...
<div class="row form-group">
	...
	<div class="col-9">
		<?
			...
			$fw = $post['font-weight'];
			if($fw) $fw_active = $fw == 700 ? '_active' : '';
			else $fw_active = $text_css['font-weight'] == 700 ? '_active' : '';
...
<?
	...
	$slide_style .= 'color: #'.set_value('slide_css[color]', $slide_css['color']).'; ';
	...
	<div class="slide" style="background-image: url('<?=base_url('assets/uploads/slider/'.$item['img']);?>');">
		<div class="wrapper">
			<div class="scontent" id="slideWrap" style="<?=$slide_style;?>">
				...
				<div class="sbtn">
					<a href="javascript:void(0)" class="btn_a"><?=set_value('btnText', $item['btnText'])?></a>
				</div>
			</div>
		</div>
	</div>
